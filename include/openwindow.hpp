...
#ifndef _MYNOTE_OPEN_WINDOW_HPP_
#define _MYNOTE_OPEN_WINDOW_HPP_
...
private:
    ...
    Glib::RefPtr<Gtk::Button> mOpenButton;
...
public:
    ...
    OpenWindow(MainWindow *parentMainWindow);
    ~OpenWindow();
...
#endif // _MYNOTE_OPEN_WINDOW_HPP_